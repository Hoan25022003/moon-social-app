...
const ModalHeading = ({ handleHideModal, children }) => {
  return (
    <div className="relative flex items-center h-[60px] justify-center px-5">
      ...
      <div
        className="absolute flex items-center justify-center transition-all bg-transparent rounded-full cursor-pointer w-9 h-9 top-1/2 -translate-y-2/4 text-iconColor hover:bg-graySoft right-5"
